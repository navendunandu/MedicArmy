...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_review(user_id,user_rating,user_review,review_datetime,clinic_id)"
                + "VALUES('" + session.getAttribute("uid") + "','" + request.getParameter("rating_data") + "','" + request.getParameter("user_review") + "',SYSDATE(),'" + request.getParameter("pid") + "')";
    ...
    if (request.getParameter("action") != null) {
        ...
        String query = "SELECT * FROM tbl_review  r inner join tbl_user u on r.user_id=u.user_id where clinic_id = '" + request.getParameter("id") + "' ORDER BY review_id DESC";
