...
//checking if request cotains multipart data
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("photo"))//write the name of image here it is img_product
                {
                    ...
                    String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\UserDocs\\";//path for storing image
    ...
    String InsQry = "INSERT INTO tbl_user( user_name, user_email,user_password,user_address,user_contact,user_gender,user_dob,user_photo,place_id)"
            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','" + photo + "','" + value[8] + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Guest/NewUserRegistration.jsp';
